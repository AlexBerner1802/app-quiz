...
export default function AppLayout({ children }) {
	...
	const itemsTop = useMemo(() => ([
		{ key: "quiz",    title: t("nav.quiz"),    icon: <FlaskConical size={20} />, to: "/home" },
		{ key: "results", title: t("nav.results"), icon: <Award size={20} />,        to: "/results" },
		{ key: "search",  title: t("nav.search"),  icon: <Search size={20} />,       to: "/search" },
	]), [t]);

	const itemsBottom = useMemo(() => ([
		{ key: "content",  title: t("nav.content"),  icon: <Layers size={20} />,       to: "/content" },
		{ key: "settings", title: t("nav.settings"), icon: <SettingsIcon size={20} />, to: "/settings" },
		{ key: "logout",   title: t("nav.logout"),   icon: <LogOut size={20} color="#ef4444" />, onClick: handleLogoutClick },

...
export const confettiRainbowPreset = {
	...
	particles: {
		...
		move: { enable: true, outModes: { top: "none", default: "destroy" }, gravity: { enable: true }, speed: { min: 5, max: 20 }, decay: 0.01 },
		number: { value: 0, limit: 300 },
		opacity: { value: 1 },
		shape: { type: ["circle", "square", "triangle"] },
		size: { value: { min: 2, max: 5 }, animation: { enable: true, speed: 5, sync: true } },
		...
		roll: { darken: { enable: true, value: 25 }, enable: true, speed: { min: 15, max: 25 } },
		wobble: { distance: 30, enable: true, speed: { min: -15, max: 15 } },
	},
	emitters: [
		{ direction: "top-right", rate: { quantity: 15, delay: 0.3 }, size: { width: 0, height: 0 }, position: { x: 0, y: 30 } },
		{ direction: "top-left", rate: { quantity: 15, delay: 0.3 }, size: { width: 0, height: 0 }, position: { x: 100, y: 30 } },
	],
};
